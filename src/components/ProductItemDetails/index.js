...
class ProductItemDetails extends Component {
  ...
  getProductData = async () => {
    ...
    if (response.ok) {
      ...
      const updatedSimilarProductData = fetchData.similar_products.map(
      ...
      <div className="product-details-success-view">
        <div className="product-details-container">
          ...
          <div className="product">
            ...
            <hr className="horizontai-line" />
            <div className="quantity-container">
              <button
                type="button"
                className="quantity-controller-button"
                onClick={this.onDecrememtQuantity}
                data-testid="minus"
              >
              ...
              <button
                type="button"
                className="quantity-controller-button"
                onClick={this.onIncrememtQuantity}
                data-testid="plus"
              >
